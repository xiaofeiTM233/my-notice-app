...
use gpui::{
    App, Div, IntoElement, ParentElement, SharedString, Styled, div, prelude::FluentBuilder as _,
    px,
};
use gpui_component::{
...
pub fn detail_content(message: &Rc<NoticeMessage>, cx: &App) -> Div {
    ...
    v_flex()
            ...
            h_flex()
                ...
                .child(
                    div()
                        ...
                        .child(Icon::new(kind_icon(kind)).medium().text_color(kind_color)),
                )
                .child(
                    div()
                        .flex_1()
        ...
        .child(
            ...
            h_flex()
                ...
                .gap_1()
                .flex_wrap()
                .child(meta_pill(cx, kind.display_name(), kind_color))
                .child(meta_pill(cx, priority.display_name(), priority_color))
                .child(meta_pill(
                    cx,
        ...
        .child(
            ...
            div().flex_1().overflow_hidden().child(
                text::markdown(body_text(message).to_string())
                    .scrollable(true)
                    .selectable(true)
                    .text_base(),
            ),
...
/// 小圆角标签（类型 / 优先级 / 频道）。
fn meta_pill(cx: &App, text: &str, color: gpui::Hsla) -> Div {
    div()
        .px_1()
        .py_0p5()
        .rounded_full()
